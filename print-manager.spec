...
Version  : 6.3.0
Release  : 83
URL      : https://download.kde.org/stable/plasma/6.3.0/print-manager-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.0/print-manager-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/print-manager-6.3.0.tar.xz.sig
...
%setup -q -n print-manager-6.3.0
cd %{_builddir}/print-manager-6.3.0
pushd ..
cp -a print-manager-6.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739294459
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcupslib.so.6.3.0
...
/usr/lib64/libkcupslib.so.6.3.0
