...
Version  : 19.12.2
Release  : 16
URL      : https://download.kde.org/stable/release-service/19.12.2/src/print-manager-19.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/print-manager-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/print-manager-19.12.2.tar.xz.sig
...
%prep
%setup -q -n print-manager-19.12.2
cd %{_builddir}/print-manager-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581050255
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/print-manager-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/print-manager/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
