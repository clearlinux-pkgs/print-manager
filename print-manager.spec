...
Version  : 6.2.4
Release  : 80
URL      : https://download.kde.org/stable/plasma/6.2.4/print-manager-6.2.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.4/print-manager-6.2.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.4/print-manager-6.2.4.tar.xz.sig
...
%setup -q -n print-manager-6.2.4
cd %{_builddir}/print-manager-6.2.4
pushd ..
cp -a print-manager-6.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735164986
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcupslib.so.6.2.4
...
/usr/lib64/libkcupslib.so.6.2.4
