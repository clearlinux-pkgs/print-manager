...
Version  : 21.12.0
Release  : 34
URL      : https://download.kde.org/stable/release-service/21.12.0/src/print-manager-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/print-manager-21.12.0.tar.xz
...
%prep
%setup -q -n print-manager-21.12.0
cd %{_builddir}/print-manager-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639607557
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/print-manager-21.12.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/print-manager/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/print-manager-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/print-manager/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/print-manager-21.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/print-manager/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/print-manager-21.12.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/print-manager/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/print-manager-21.12.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/print-manager/19d98e1b6f8ef12849ea4012a052d3907f336c91
cp %{_builddir}/print-manager-21.12.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/print-manager/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/print-manager-21.12.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/print-manager/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
