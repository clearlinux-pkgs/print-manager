...
Version  : 6.2.0
Release  : 79
URL      : https://download.kde.org/stable/plasma/6.2.0/print-manager-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.0/print-manager-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/print-manager-6.2.0.tar.xz.sig
...
%setup -q -n print-manager-6.2.0
cd %{_builddir}/print-manager-6.2.0
pushd ..
cp -a print-manager-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728571416
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcupslib.so.6.2.0
...
/usr/lib64/libkcupslib.so.6.2.0
