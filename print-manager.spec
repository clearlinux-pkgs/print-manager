...
Version  : 18.12.3
Release  : 4
URL      : https://download.kde.org/stable/applications/18.12.3/src/print-manager-18.12.3.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.3/src/print-manager-18.12.3.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.3/src/print-manager-18.12.3.tar.xz.sig
...
%prep
%setup -q -n print-manager-18.12.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1555345868
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
