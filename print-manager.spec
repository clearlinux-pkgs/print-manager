...
Source0  : https://download.kde.org/stable/plasma/6.1.1/print-manager-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/print-manager-6.1.1.tar.xz.sig
...
%setup -q -n print-manager-6.1.1
cd %{_builddir}/print-manager-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719428226
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcupslib.so.6.1.1
...
/usr/lib64/libkcupslib.so.6.1.1
