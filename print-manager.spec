...
Version  : 6.1.5
Release  : 78
URL      : https://download.kde.org/stable/plasma/6.1.5/print-manager-6.1.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.5/print-manager-6.1.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.5/print-manager-6.1.5.tar.xz.sig
...
%setup -q -n print-manager-6.1.5
cd %{_builddir}/print-manager-6.1.5
pushd ..
cp -a print-manager-6.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726005752
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcupslib.so.6.1.5
...
/usr/lib64/libkcupslib.so.6.1.5
