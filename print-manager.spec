...
Source0  : https://download.kde.org/stable/release-service/21.04.0/src/print-manager-21.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.0/src/print-manager-21.04.0.tar.xz.sig
...
%prep
%setup -q -n print-manager-21.04.0
cd %{_builddir}/print-manager-21.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619244278
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/print-manager-21.04.0/COPYING %{buildroot}/usr/share/package-licenses/print-manager/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
