...
Version  : 20.08.3
Release  : 24
URL      : https://download.kde.org/stable/release-service/20.08.3/src/print-manager-20.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/print-manager-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/print-manager-20.08.3.tar.xz.sig
...
%prep
%setup -q -n print-manager-20.08.3
cd %{_builddir}/print-manager-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604621041
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/print-manager-20.08.3/COPYING %{buildroot}/usr/share/package-licenses/print-manager/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
